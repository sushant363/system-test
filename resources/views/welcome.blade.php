    ...
    <body class="antialiased">
        ...
        <form method="POST" action="{{route('form.submit')}}">
            ...
            <div class="form-group">
                ...
                <input type="date" name="dob" value="{{old('dob')}}" class="form-control" id="dob" placeholder="Enter DOB">
                @error('dob')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="text" name="mobile" value="{{old('mobile')}}" class="form-control" id="mobile" placeholder="Enter Mobile">
                @error('mobile')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
